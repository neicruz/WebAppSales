...
using SalesWebMvcVersion.Models.Enums;

namespace SalesWebMvcVersion.Data
{
    public class SeedingService
    {
        private SalesWebMvcVersionContext _context;

        public SeedingService(SalesWebMvcVersionContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            _context.Department.AddRange(d1, d2, d3, d4);//ADICIONA AO BANCO DE DADOS VARIOS OBJETOS DE UMA UNICA VEZ
